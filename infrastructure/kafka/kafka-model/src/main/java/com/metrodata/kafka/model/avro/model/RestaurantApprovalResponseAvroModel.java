...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.metrodata.kafka.model.avro.model.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(com.metrodata.kafka.model.avro.model.OrderApprovalStatus value) {
   ...
   */
  public static com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.metrodata.kafka.model.avro.model.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
