package com.metrodata.payment.service.dataaccess.outbox.adapter;

import com.metrodata.common.domain.valueobject.PaymentStatus;
import com.metrodata.outbox.OutboxStatus;
import com.metrodata.payment.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import com.metrodata.payment.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import com.metrodata.payment.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import com.metrodata.payment.service.domain.application.outbox.model.OrderOutboxMessage;
import com.metrodata.payment.service.domain.application.ports.output.repository.OrderOutboxRepository;
