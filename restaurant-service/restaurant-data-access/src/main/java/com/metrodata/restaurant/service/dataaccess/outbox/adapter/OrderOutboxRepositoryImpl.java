package com.metrodata.restaurant.service.dataaccess.outbox.adapter;

import com.metrodata.outbox.OutboxStatus;
import com.metrodata.restaurant.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import com.metrodata.restaurant.service.domain.application.outbox.model.OrderOutboxMessage;
import com.metrodata.restaurant.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import com.metrodata.restaurant.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import com.metrodata.restaurant.service.domain.application.ports.output.repository.OrderOutboxRepository;
